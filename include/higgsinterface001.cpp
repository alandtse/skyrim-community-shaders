...
struct HiggsMessage
{
	enum: std::uint32_t
	{
		kMessage_GetInterface = 0xF9279A57
	};  // Randomly generated
...
HiggsPluginAPI::IHiggsInterface001* HiggsPluginAPI::GetHiggsInterface001(const SKSE::PluginHandle&, const SKSE::MessagingInterface* messagingInterface)
{
	...
	messagingInterface->Dispatch(HiggsMessage::kMessage_GetInterface, (void*)&higgsMessage, sizeof(HiggsMessage*), "HIGGS");
